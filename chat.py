...
from model_v2 import generate_answer
...
def process_pdf_data(pdf_path, output_dir="output"):
    ...
    try:
        ...
        return None
def main():
    # Configuration de la page avec le nouveau design
    st.set_page_config(page_title="Chat PDF AI", layout="wide")
    st.title("📄 Chat with Your PDF ")
    
    
    # Barre latérale pour le téléchargement des fichiers PDF
    st.sidebar.header("📂 Upload PDFs")
    uploaded_file = st.sidebar.file_uploader("Upload your PDF(s)", type=["pdf"])
    ...
    if uploaded_file is not None:
        ...
        if text:
            ...
            # Affichage de l'historique des conversations avec le nouveau design
            ...
            for message in st.session_state.history:
                if message['role'] == "Utilisateur":
                    ...
                    <div style="display: flex; align-items: center; margin-bottom: 10px;">
                        <img src="https://cdn-icons-png.flaticon.com/512/5151/5151840.png" width="40" height="40" style="margin-right: 10px; border-radius: 50%; border: 2px solid #007BFF;">
            ...
            with col1:
                if st.button("Envoyer"):
                    if query:
                        ...
                        answer = generate_answer(cleaned_text, query)
                        
                        # Ajout de la question et de la réponse à l'historique
                        st.session_state.history.append({"role": "Utilisateur", "content": query})
